...
//admin
let loginAdmin = require('./components/admin/login.vue').default;
// End Authentication 
...
let editexpense = require('./components/expense/edit.vue').default;
  ...
  // Salary Component 
let paysalary = require('./components/salary/all_employee.vue').default;
let salary = require('./components/salary/create.vue').default;
...
let pos = require('./components/admin/pos/pointofsale.vue').default;
...
// Salary Routes
  { path: '/given-salary/:id', component: salary, name:'given-salary'},
