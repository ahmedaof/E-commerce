 ...
 <div class="row">
  <router-link to="/supplier" class="btn btn-primary">All supplier </router-link>
    ...
    <div class="row justify-content-center">
      ...
      <form class="user" @submit.prevent="supplierEdit" enctype="multipart/form-data">
     ...
     <div class="col-md-6">
         <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your shopname" v-model="form.shopname">
