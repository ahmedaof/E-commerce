...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/pay-salary">Add Salary</router-link>
...
<nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top" id="topbar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display: none;">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; - developed by Ahmed Ibrahim
  ...
  <script src="{{ asset('materialize-css/dist/js/materialize.min.js')}}"></script>  
</body>
